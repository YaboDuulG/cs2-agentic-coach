...
from services.scout.service import parse_match, ParseRequest
...
async def test_scout_recon_validation_bypass():
    ...
    with patch("services.scout.service.LOCAL_MODE", True), \
         ...
         patch("services.scout.service._trigger_coaching") as mock_trigger, \
         patch("services.scout.service._mark_failed") as mock_failed, \
