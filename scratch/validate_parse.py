...
if empty_winner_rounds:
    ...
    print("  [OK] No rounds with empty winner_side")
print()
...
if zero_kill_rounds:
    ...
    print("  [OK] All rounds have at least 1 kill")
print()
...
try:
    ...
    print(f"  [PASS] total_rounds >= 15  (got {total_rounds})")
...
try:
    ...
    print(f"  [PASS] warmup detected: {warmup_excluded}")
except AssertionError as e:
    errors.append(str(e))
    print(f"  [FAIL] {e}")
