...
| **Parser library tracking** | demoinfocs-golang pinned to latest (v4.5.1, 2026-09) | Valve's CS2 updates change the demo entity format; an old pin fails with 'unable to find existing entity' on any demo recorded after the update. Bump the pin whenever real-demo parses start 500ing |
