...
async def analyze_round_flash(client: genai.Client, round_num: int, round_data: dict, map_playbook: dict, rag_context: list) -> str:
...
async def async_generate_reports(
    ...
    focus_instruction = recon_prompt if is_recon else focus_prompt_template.format(user_team=user_team, uploader_steam_id=uploader_steam_id) if user_team else ""
...
def generate_reports(
    ...
    return asyncio.run(async_generate_reports(match_id, scout_out, rag_context, tactical_analysis, map_playbook))
